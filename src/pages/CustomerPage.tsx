...
import Dialog from "../components/DialogBox"; // Import the Dialog component
...
const CustomerPage = () => {
  ...
  return (
    <div className="p-6">
      ...
      {/* Customer Dialog */}
      <Dialog isOpen={isDialogOpen} onClose={resetForm}>
          ...
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-semibold text-gray-800">
              ...
              {dialogMode === "edit" && editingCustomer && (
                <span className="text-gray-500 text-base font-normal ml-2">ID: {editingCustomer.id}</span>
              )}
            </h3>
            <button
              onClick={resetForm}
